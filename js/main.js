...
async function displayAlbums() {
    ...
    let a1 = await fetch(`/songs/Angry_(mood)/info.json`)
    ...
    let a2 = await fetch(`/songs/Bright_(mood)/info.json`)
    ...
    let a3 = await fetch(`/songs/Chill_(mood)/info.json`)
    ...
    let a4 = await fetch(`/songs/cs/info.json`)
    ...
    let a5 = await fetch(`/songs/Dark_(mood)/info.json`)
    ...
    let a6 = await fetch(`/songs/Diljit/info.json`)
    ...
    let a7 = await fetch(`/songs/Funky_(mood)/info.json`)
    ...
    let a8 = await fetch(`/songs/karanaujla/info.json`)
    ...
    let a9 = await fetch(`/songs/Love_(mood)/info.json`)
    ...
    let a11 = await fetch(`/songs/Uplifting_(mood)/info.json`)
